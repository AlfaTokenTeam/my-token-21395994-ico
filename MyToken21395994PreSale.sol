...
import "./MyToken21395994.sol";

contract MyToken21395994PreSale {
    MyToken21395994 public token;
    ...
    function MyToken21395994PreSale(
        MyToken21395994 _token,
        address _beneficiary,
        address _alfatokenteam
    ) {
        token = MyToken21395994(_token);
